...
modified_data= read.table("/home/melak/My_Google/Open_data/Open_Data_3_2/IODS-project/data/modified_data.txt", sep="\t", header=TRUE)
...
```
The above 2x2 cross tabulation indicates that out of 382 observations 81 (65+ 16) were wrongly predicated. The average proportion of incorrect predictions in the data is about 21%.
